        ...
        return (
            <div className="container mx-auto px-6 py-16 md:py-24">
                <div className="max-w-lg mx-auto text-center">
                    ...
                    <button
                        onClick={() => open()}
                        className="px-6 py-3 bg-primary hover:bg-white/90 text-black font-medium rounded-xl transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)]"
                    >
                        Connect Wallet
                    </button>
                </div>
        ...
        <div className="container mx-auto px-6 py-8 md:py-12">
            ...
            <div className="border-t border-white/10 pt-8">
                ...
                <div className="flex flex-wrap gap-3">
                    <Link
                        href="/identity/link"
                        className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary hover:bg-white/90 text-black font-medium rounded-xl transition-all"
                    >

...
const config: HardhatUserConfig | any = {
    ...
    etherscan: {
        // Use per-network API keys for proper Blockscout support
        apiKey: {
            // Etherscan-based explorers
            base: ETHERSCAN_API_KEY,
            baseSepolia: ETHERSCAN_API_KEY,
            optimism: ETHERSCAN_API_KEY,
            optimismSepolia: ETHERSCAN_API_KEY,
            celo: ETHERSCAN_API_KEY,
            celoAlfajores: ETHERSCAN_API_KEY,
            zora: ETHERSCAN_API_KEY,
            // Blockscout-based explorers (use Blockscout API key)
            ink: BLOCKSCOUT_API_KEY,
            lisk: BLOCKSCOUT_API_KEY,
            unichain: BLOCKSCOUT_API_KEY,
            soneium: BLOCKSCOUT_API_KEY,
        },
        ...
        customChains: [
            ...
            // ===== BLOCKSCOUT CHAINS (use ?module=contract&action=verify format) =====
            {
                network: "ink",
                chainId: 57073,
                urls: {
